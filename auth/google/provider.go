...
const (
	...
	clientSig        = "321187995bc7cdc2b5fc91b11a96e2baa8602c62"
)

const providerString = "google"

// Provider - provider struct to match PTC
...
// NewProvider - Creating new provider for goolge
...
// GetProviderString - Get actual provider
func (p *Provider) GetProviderString() string {
	return providerString
}

// GetAccessToken - Get Google Access Token
func (p *Provider) GetAccessToken() string {
	return p.ticket
}

// Login - pokemon app login with google
